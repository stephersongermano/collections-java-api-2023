...
public class LivrariaOnline {
    ...
    // autor e preço. Através da classe "LivrariaOnline", implemente os seguintes
    // métodos:
    ...
    // adicionarLivro(String link, String titulo, String autor, private double
    // preco): Adiciona um livro à livraria, utilizando o ISBN como chave no Map.

    public void adicionarLivro(String link, Livro livro) {
        livros.put(link, livro);
    }

    // removerLivro(String titulo): Remove um livro da livraria, dado o titulo do
    // livro.
    ...
    // exibirLivrosOrdenadosPorPreco(): Exibe os livros da livraria em ordem
    // crescente de preço.
    ...
    // pesquisarLivrosPorAutor(String autor): Retorna uma lista de todos os livros
    // escritos por um determinado autor.
